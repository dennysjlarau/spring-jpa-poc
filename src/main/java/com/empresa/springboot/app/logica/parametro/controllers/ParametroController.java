...
// IDEA crear logica de negocio o facchada con la logica que tiene el controlador
...
public class ParametroController {
	...
	//@Qualifier("parametroJpaImp") seleccionar una implementacion cuando exista una interfaz y varias implementaciones por ejemplo imp para h2, otra para mysql, etc
